...
% I implement my own epipolar line drawing function, named
% 'draw_epipolar_lines2', please use this one
draw_epipolar_lines2(F_matrix,ImgLeft,ImgRight,Points_2D_pic_a,Points_2D_pic_b);
