...
%This pair is from extra data file: Sleeping Beaury Castle Paris
% image1 = imread('../data/Sleeping Beauty Castle Paris/4893248701_f046f63c48_o.jpg');
% image2 = imread('../data/Sleeping Beauty Castle Paris/4893249735_46343d0dd2_o.jpg');

%This pair is from extra data file: Pantheon Paris
% image1 = imread('../data/Pantheon Paris/3443354241_44cb110e99_o.jpg');
% image2 = imread('../data/Pantheon Paris/3665870978_550083ae6a_o.jpg');

%This pair is from extra data file: Sacre Coeur
% image1 = imread('../data/Sacre Coeur/2141753393_77b92de58d_o.jpg');
% image2 = imread('../data/Sacre Coeur/2589974552_c6e14695b2_o.jpg');
